...
from .remove_previous_targeting_location import RemoveLocation
...
def UpdateLocation(client, campaign_id, previous_location, location):
  # Initialize appropriate service.
  INFOS = []
  remove = RemoveLocation(client, campaign_id, previous_location)
  if remove[0]['status']=="removed":
